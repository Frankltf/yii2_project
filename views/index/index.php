    ...
    <div class="container">
        <div class="col-xs-12 col-lg-6 no-margin banner">
            <a href="category-grid.html">
                ...
                <img class="banner-image" alt="" src="/yii2_project/assets/images/blank.gif"
                    ...
                    <div class="product-grid-holder">
                            <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="prices">
                                        <div class="price-prev">￥111</div>
                                        <div class="price-current pull-right">￥111</div>
                                    </div>
                    ...
                    <div class="product-grid-holder">
                            <div class="col-sm-4 col-md-3  no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <div class="prices">
                                        <div class="price-prev">￥111</div>
                                        <div class="price-current pull-right">￥aaaa</div>
                                    </div>
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div class="prices text-right">
                        <div class="price-current inline">￥3333</div>
                        <a href=""
            ...
            <div id="owl-recently-viewed" class="owl-carousel product-grid-holder">
                    <div class="no-margin carousel-item product-item-holder size-small hover">
                        <div class="product-item">
                            ...
                            <div class="prices">
                                <div class="price-current text-right">￥333</div>
                            </div>
                            <div class="hover-area">
                                <div class="add-cart-button">
                                    <a href=""
        ...
        <div class="carousel-holder">
            ...
            <div id="owl-brands" class="owl-carousel brands-carousel">
                ...
                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/yii2_project/assets/images/brands/brand-01.jpg"/>
                    </a>
                </div><!-- /.carousel-item -->

                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/yii2_project/assets/images/brands/brand-02.jpg"/>
                    </a>
                </div><!-- /.carousel-item -->

                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/yii2_project/assets/images/brands/brand-03.jpg"/>
                    </a>
                </div><!-- /.carousel-item -->

                <div class="carousel-item">
                    <a href="#">
                        <img alt="" src="/yii2_project/assets/images/brands/brand-04.jpg"/>
                    </a>
                </div><!-- /.carousel-item -->
