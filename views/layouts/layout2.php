                ...
                <div class="yamm navbar">
                    ...
                    <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                        <ul class="nav navbar-nav">
                            <li class="dropdown">
                                <a href="" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">aaa</a>
                                <ul class="dropdown-menu">
                                    <li>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-9 no-margin">
                                            <a href="">2222</a>
                                            <div class="price">
                                                <div class="price-prev">￥aaaa</div>
                                                <div class="price-current">￥aaaa</div>
                                            </div>
                                        </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-9 no-margin">
                                            <a href="">aaa</a>
                                            <div class="price">
                                                <div class="price-prev">￥aaa</div>
                                                <div class="price-current">￥aaa</div>
                                            </div>
                                        </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-9 no-margin">
                                            <a href="">aaaa</a>
                                            <div class="price">
                                                <div class="price-prev">￥222</div>
                                                <div class="price-current">￥3333</div>
                                            </div>
                                        </div>
