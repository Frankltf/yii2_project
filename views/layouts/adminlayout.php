        ...
        <ul class="nav pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo yii\helpers\Url::to(['admin/userinfo','actiontype'=>2])?>">个人信息管理</a></li>
                    <li><a href="#">修改密码</a></li>
                    <li><a href="#">订单管理</a></li>
                </ul>
            </li>
            ...
            <li class="settings hidden-phone">
                <a href="<?php echo yii\helpers\Url::to(['admin/loginout'])?>" role="button">
...
<div id="sidebar-nav">
    <ul id="dashboard-menu">
        ...
        <li>
            <a href="<?php echo yii\helpers\Url::to(['admin/userinfo','actiontype'=>1]);?>">
                <i class="icon-cog"></i>
                <span>我的信息</span>
            </a>
        </li>
